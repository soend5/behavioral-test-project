 ...
 * - 创建初始 admin 账号
 * - 创建初始 coach 账号
 * - 创建 quiz v1 骨架（fast/pro）
 * - 创建默认 coaching_stage
 * 
 * 运行方式：
 * - 首次部署：npm run seed:prod
 * - 后续部署：无需运行（幂等）
 */
...
async function main() {
  ...
  console.log("⚠️  重要提示：");
  console.log("   1. 请立即修改 admin 和 coach 的默认密码");
  console.log("   2. 请在 admin 后台配置题库和 SOP");
}
